...
/** A human-readable string in every locale. */
export type Localized = Record<Locale, string>;

export type Asset = {
  /** Path under /public, always starting with "/". */
  file: string;
  /** Human label shown on the placeholder and used as alt text, per locale. */
  label: Localized;
...
/** The asset's label in the active locale. */
export function assetLabel(a: Asset, lang: Locale): string {
  return a.label[lang];
}
...
export const serviceScreens: Record<string, Asset> = {
  consultations: { file: "/app/services/consultations.png", label: { fr: "Consultations & rendez-vous", en: "Consultations & appointments" }, variant: "phone" },
  "hopitaux-labos": { file: "/app/services/hopitaux-labos.png", label: { fr: "Hôpitaux & laboratoires", en: "Hospitals & laboratories" }, variant: "phone" },
  pharmacie: { file: "/app/services/pharmacie.png", label: { fr: "Pharmacie", en: "Pharmacy" }, variant: "phone" },
  assurance: { file: "/app/services/assurance.png", label: { fr: "Assurance santé", en: "Health insurance" }, variant: "phone" },
  dons: { file: "/app/services/dons.png", label: { fr: "Dons ONG & projets santé", en: "NGO donations & health projects" }, variant: "phone" },
  "protection-famille": { file: "/app/services/protection-famille.png", label: { fr: "Protection famille", en: "Family protection" }, variant: "phone" },
  epargne: { file: "/app/services/epargne.png", label: { fr: "Épargne santé SOSAN", en: "SOSAN health savings" }, variant: "phone" },
  "profil-medical": { file: "/app/services/profil-medical.png", label: { fr: "Profil médical & documents", en: "Medical profile & records" }, variant: "phone" },
  "assistant-ia": { file: "/app/services/assistant-ia.png", label: { fr: "Assistant santé IA", en: "AI health assistant" }, variant: "phone" },
  communaute: { file: "/app/services/communaute.png", label: { fr: "Communauté & conseils santé", en: "Community & health tips" }, variant: "phone" },
};
...
export const planPhotos: Record<string, Asset> = {
  silver: {
    ...
    label: { fr: "Diaspo Silver", en: "Diaspo Silver" },
    variant: "photo",
  ...
  gold: {
    ...
    label: { fr: "Diaspo Gold", en: "Diaspo Gold" },
    variant: "photo",
  ...
  premium: {
    ...
    label: { fr: "Diaspo Premium", en: "Diaspo Premium" },
    variant: "photo",
...
export const aboutGallery: Asset[] = [
  { file: "/app/about/ap1.jpg", label: { fr: "SOSAN sur le terrain", en: "SOSAN in the field" }, variant: "photo", fallback: `${CDN}/v1/670f885de587b3675c7f85ee/92306aec-38f7-434e-abb0-1ee3840eed74/ap1.png` },
  { file: "/app/about/ap2.jpg", label: { fr: "SOSAN sur le terrain", en: "SOSAN in the field" }, variant: "photo", fallback: `${CDN}/v1/670f885de587b3675c7f85ee/a08d3e76-4f0c-424e-8a9e-be012dad8b38/ap2.png` },
  { file: "/app/about/ap3.jpg", label: { fr: "SOSAN sur le terrain", en: "SOSAN in the field" }, variant: "photo", fallback: `${CDN}/v1/670f885de587b3675c7f85ee/2dec504e-ee20-46ff-84e6-764fae3e6ecd/ap3.png` },
  { file: "/app/about/ap4.jpg", label: { fr: "SOSAN sur le terrain", en: "SOSAN in the field" }, variant: "photo", fallback: `${CDN}/v1/670f885de587b3675c7f85ee/c9809d40-655c-43b9-8a7a-288954fd9ca7/ap4.png` },
];
...
export const homeAbout: Asset = {
  ...
  label: { fr: "L’application SOSAN", en: "The SOSAN app" },
  variant: "phone",
...
export const diaspoHero: Asset = {
  ...
  label: { fr: "Diaspo Support", en: "Diaspo Support" },
  variant: "photo",
  fallback: `${CDN}/670f885de587b3675c7f85ee/baf5f793-c639-481a-9fd9-53f86291219e/19507.jpg.jpeg?content-type=image%2Fjpeg`,
};
...
export const testimonialAvatars: Record<string, Asset> = {
  "emmanuel-fotso": { file: "/app/testimonials/emmanuel-fotso.jpg", label: { fr: "Emmanuel Fotso", en: "Emmanuel Fotso" }, variant: "photo", fallback: `${CDN}/670f885de587b3675c7f85ee/a4d87498-101f-406f-b13d-a61a6504b7e2/19641.jpg?content-type=image%2Fjpeg` },
  "aicha-mbarga": { file: "/app/testimonials/aicha-mbarga.jpg", label: { fr: "Aïcha Mbarga", en: "Aïcha Mbarga" }, variant: "photo", fallback: `${CDN}/670f885de587b3675c7f85ee/8aa4e46b-ec61-4850-b62c-3bfdc726ddf6/146757.jpg?content-type=image%2Fjpeg` },
  "herve-etoundi": { file: "/app/testimonials/herve-etoundi.jpg", label: { fr: "Hervé Etoundi", en: "Hervé Etoundi" }, variant: "photo", fallback: `${CDN}/670f885de587b3675c7f85ee/50ced21f-0bae-4bb3-9b42-de3189f21207/128895.jpg?content-type=image%2Fjpeg` },
};
...
export function newsCover(slug: string, title: string): Asset {
  // `title` arrives already localised from the active locale's news data.
  return {
    file: `/app/actualites/${slug}.jpg`,
