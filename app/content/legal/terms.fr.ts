/**
 * Terms and conditions text for /terms/, kept as plain strings rather than JSX
 * so the clauses can be edited without tripping over JSX entity escaping.
 */
import type { LegalDocument } from "../../LegalDoc";

export const doc: LegalDocument = {
  title: "Termes et Conditions d’Utilisation de SOSAN",
  intro:
    "Ces conditions encadrent l’utilisation de l’application et de la plateforme SOSAN : objet du service, obligations des professionnels de santé, propriété intellectuelle, remboursements et garanties.",
  sections: [
  {
    id: "introduction",
